...
>>>>>>> 64a8f32134e5edf3a8d326677b783f2049a3e543
os.system("cls")
    ...
    while not guessed and tries > 0:
        ...
        if len(guess) == 1 and guess.isalpha():
            if guess in guessed_letters:
                ...
                print(guess, "is not in the word. You have",tries,"tries left!")
                tries -= 1
                #print("You have",str(tries),"more tries left.")
            ...
            if guess in guessed_words:
                ...
                print(guess, "is not the word. You have",tries,"tries left!")
                tries -= 1
                #print("You have",str(tries),"more tries left.")
